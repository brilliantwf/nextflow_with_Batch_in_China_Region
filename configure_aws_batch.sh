...
aws iam attach-group-policy --group-name $IAM_GROUP_NAME \
        --policy-arn arn:aws-cn:iam::aws:policy/AWSBatchFullAccess
aws iam attach-group-policy --group-name $IAM_GROUP_NAME \
...
aws iam attach-role-policy --role-name $IAM_ROLE_NAME \
    --policy-arn arn:aws-cn:iam::aws:policy/service-role/AmazonEC2SpotFleetTaggingRole
aws iam attach-role-policy --role-name $IAM_ROLE_NAME \
    --policy-arn arn:aws-cn:iam::aws:policy/service-role/AmazonEC2ContainerServiceforEC2Role
aws iam attach-role-policy --role-name $IAM_ROLE_NAME \
    --policy-arn arn:aws-cn:iam::aws:policy/AmazonEC2ContainerRegistryReadOnly
timestamp=$(date -I)
...
aws batch create-compute-environment \
    ...
    --service-role "arn:aws-cn:iam::"$ACCOUNT_ID":role/aws-service-role/batch.amazonaws.com/AWSServiceRoleForBatch"
sleep 60
timestamp=$(date -I)
